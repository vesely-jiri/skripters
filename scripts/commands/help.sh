...
cmd::help() {
    ...
    echo -e "  start            Start the environment"
    ...
    echo -e "  --build              Rebuild Docker images on 'start'"
    echo -e "  --tail <N>           Show the last N lines of logs"
    echo -e ""
    echo -e "Examples:"
    echo -e "  $0 start --env=development           # Start development environment"
    echo -e "  $0 stop --env=production --volumes   # Stop production and remove volumes"
